...
import com.wandao.myapplication.manager.ImportFileManager;
...
public class BatchImportActivity extends BaseActivity implements View.OnClickListener, OnImportListener,
    ...
    private com.wandao.myapplication.manager.ImportFileManager mImportFileManager;
    ...
    private void initData() {
        mImportFileManager = ImportFileManager.getInstance().getInstance();

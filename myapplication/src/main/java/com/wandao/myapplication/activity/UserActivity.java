...
import com.baidu.idl.sample.ui.DBImportActivity;
...
//            startActivity(intent);
            ...
            builder = new AlertDialog.Builder(this).setIcon(R.mipmap.ic_register).setTitle("人脸库管理")
                    .setMessage("是否重新注册？").setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            intent.putExtra("id", mListFeatureInfo.get(pos).getUserName());
                            startActivity(intent);
                        }

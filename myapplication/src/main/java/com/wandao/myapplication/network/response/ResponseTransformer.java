...
import com.wandao.myapplication.network.Exception.ApiException;
import com.wandao.myapplication.network.Exception.CustomException;
...
public class ResponseTransformer {
    ...
    public static <T> ObservableTransformer<LogResponse, T> handleLogResult() {
        Log.d("2341qqq",handleLogResult().toString());
        return null;
    }

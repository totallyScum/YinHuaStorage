package com.wandao.myapplication.ui;
...
setTextSize(20);
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (isMorphing==true){
            final RectF rectF=new RectF(getWidth()*5/12,getHeight()/7,getWidth()*7/12,getHeight()-getHeight()/3);
            canvas.drawArc(rectF,startAngle,250,false,paint);
        }
    }
}
